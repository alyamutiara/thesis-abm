...
<experiments>
  ...
  <experiment name="adult" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="600"/>
    <metric>mean [travel-distance] of persons</metric>
  ...
  <experiment name="senior" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="600"/>
    <metric>mean [travel-distance] of persons</metric>
  ...
  <experiment name="child" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="600"/>
    <metric>mean [travel-distance] of persons</metric>
  ...
  <experiment name="disable" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="500"/>
    <metric>mean [travel-distance] of persons</metric>
